...
function inserir_Usuario($nome,$telefone,$email,$ra,$rg,$senha){
    ...
    echo"<script language='javascript' type='text/javascript'>alert('RA já existente');window.location.href='../View/html/frm_cadastrar.php';</script>";
  ...
  $sql = "INSERT INTO usuario (nome,telefone,email,ra,rg,senha) values('$nome','$telefone','$email','$ra','$rg','$senha')";
    ...
    echo"<script language='javascript' type='text/javascript'>alert('Aluno Cadastrado com sucesso');window.location.href='../View/html/frm_cadastrar.php';</script>";
   ...
   function selecionar_Usuario($ra,$senha){
        ...
        $result_usuario = "SELECT nome, ra, senha FROM usuario WHERE ra= '$ra' && senha = '$senha' LIMIT 1";
